...
- **Add the window you're in.** Press ⌥Space, select the room and press **⌘↩**: the window joins the room and you walk in with it laid out. **Add This Window** in the menu does the same for the room you're in. A room with My Layout goes back to Auto until you adjust it again, since the new window has no place in it yet.
